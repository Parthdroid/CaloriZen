...
| `AI_INTEGRATIONS_OPENAI_BASE_URL` | Feature-dependent   | Base URL for the existing nutrition-analysis integration; keep server-side.                                                                                             |
| `AI_INTEGRATIONS_OPENAI_API_KEY`  | Feature-dependent   | API key for the existing nutrition-analysis integration; keep server-side.                                                                                              |
