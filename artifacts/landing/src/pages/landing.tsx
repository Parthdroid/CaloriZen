      ...
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-bold text-gray-900">
            CaloriZen<span className="text-xs align-super">™</span>
          </span>
        </div>
        ...
        <div className="flex items-center gap-2">
          <a
            href="#download"
            className="hidden sm:flex items-center gap-2 bg-black text-white text-sm font-medium px-4 py-2 rounded-lg hover:bg-gray-800 transition-colors"
          >
          ...
          <div>
            <div className="flex items-center gap-2 mb-6">
              <div className="flex -space-x-2">
                <div className="w-8 h-8 rounded-full bg-green-100 border-2 border-white flex items-center justify-center text-xs">
                  A
                </div>
                <div className="w-8 h-8 rounded-full bg-emerald-100 border-2 border-white flex items-center justify-center text-xs">
                  K
                </div>
                <div className="w-8 h-8 rounded-full bg-teal-100 border-2 border-white flex items-center justify-center text-xs">
                  M
                </div>
              </div>
              <span className="text-sm text-gray-600">
                Loved by thousands with
              </span>
            ...
            <p className="mt-6 text-lg text-gray-500 leading-relaxed max-w-md">
              Meet CaloriZen, the AI-powered app for easy calorie tracking. Snap
              a photo, scan a barcode, or describe your meal and get instant
              calorie and nutrient info.
            </p>
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a
                href="#download"
                className="inline-flex items-center gap-2.5 bg-black text-white font-medium px-5 py-3 rounded-xl hover:bg-gray-800 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
                <svg
                  className="w-5 h-5"
                  viewBox="0 0 24 24"
                  ...
                  <div className="px-4 pt-10 pb-4">
                    ...
                    <div className="space-y-1.5">
                      <div className="bg-white rounded-xl p-2.5 shadow-sm border border-gray-100 flex items-center gap-2.5">
                        ...
                        <span className="text-[9px] font-semibold text-[#FF6B35] bg-orange-50 px-1.5 py-0.5 rounded">
                          320
                        </span>
                      </div>
                      <div className="bg-white rounded-xl p-2.5 shadow-sm border border-gray-100 flex items-center gap-2.5">
                        <div className="w-7 h-7 rounded-lg bg-amber-50 flex items-center justify-center text-xs">
                          🥣
                        </div>
                        <div className="flex-1 min-w-0">
                          <p className="font-semibold text-[10px] text-gray-900">
                ...
                <div className="w-full h-full rounded-[2rem] overflow-hidden bg-[#F8F8FA] flex flex-col">
                  <div className="px-4 pt-8">
                    ...
                    <div className="relative bg-gray-100 rounded-2xl aspect-square flex items-center justify-center mb-3 border-2 border-dashed border-gray-200">
                      ...
                      <p className="absolute bottom-2.5 text-[9px] font-medium text-gray-400">
                        Take a Photo
                      </p>
                    </div>
                    <div className="space-y-1.5">
...
function Features() {
  const features = [
    ...
    },
    {
      ...
      desc: "Use secure email login or Sign in with Apple. Account data is isolated and meal photos are not retained in the meal database.",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-gray-500 text-lg max-w-2xl mx-auto">
            Powered by advanced AI that understands food better than any other
            app.
          </p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f) => (
            <div
              key={f.title}
              className="bg-white rounded-2xl p-7 hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-gray-200 group"
            >
  ...
  const steps = [
    {
      num: "1",
      title: "Snap a photo",
      desc: "Take a picture of your meal, scan a barcode, or type a description.",
    },
    {
      num: "2",
      title: "AI analyzes instantly",
      desc: "Our AI identifies every food item and calculates precise nutritional values.",
    },
    {
      num: "3",
      title: "Track your day",
      desc: "See your daily totals update in real-time with beautiful macro breakdowns.",
    },
  ];
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {steps.map((s) => (
            <div key={s.num} className="text-center">
              <div className="w-14 h-14 rounded-2xl bg-green-50 text-green-700 font-bold text-xl flex items-center justify-center mx-auto mb-5 border border-green-100">
                {s.num}
              </div>
    ...
    <section id="download" className="py-20 md:py-28 bg-gray-900 text-white">
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        <p className="text-gray-400 text-lg mb-10 max-w-lg mx-auto">
          Download CaloriZen today and start tracking smarter, not harder. Free
          to get started.
        </p>
        <div className="flex flex-wrap gap-4 justify-center items-center">
          <span className="inline-flex items-center gap-3 bg-white text-gray-900 font-medium px-6 py-3.5 rounded-xl">
        ...
        <div className="grid md:grid-cols-4 gap-10 mb-10">
          <div className="md:col-span-1">
            ...
            <p className="text-sm leading-relaxed">
              AI-powered nutrition tracking from a single photo.
            </p>
          </div>
          <div>
